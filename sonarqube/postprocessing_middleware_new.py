...
if __name__ == "__main__":
    builder = CAOutputBuilder()
    input_json_path = r'C:\Users\1928044\Videos\sonarqube\jsons\input-style3.json'
    with open(input_json_path,'r',encoding='utf-8') as f:
        input_json = json.load(f)
    output = builder.set_output_dynamic(input_json)

out_path = r'C:\Users\1928044\Videos\sonarqube\jsons\output\test1.json'
with open(out_path,'w',encoding='utf-8') as wf:
	wf.write(json.dumps(output))

ui_output = final_preprocess(output,True,12345,1,"BOI",12-10-1999,"BOI.pdf","AI generated content, created using gpt-oss, by 19425, on 2026-02-21 20:02:37 using TCS BaNCS AI Compass - GenAI Services.")
input_json_path = r'C:\Users\1928044\Videos\sonarqube\jsons\output\new_output_1.json'
with open(input_json_path,'w',encoding='utf-8') as wf:
	wf.write(json.dumps(ui_output, indent=2))
